...
public class GravitySphere : GravitySource
{
    ...
    [SerializeField, Min(0.0f)] float outerRadius = 20.0f;
    [SerializeField, Min(0.0f)] float outerFalloffRadius = 25.0f;
    [SerializeField, Min(0.0f)] float innerRadius = 5.0f;
    [SerializeField, Min(0.0f)] float innerFalloffRadius = 1.0f;
