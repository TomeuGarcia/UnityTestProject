...
public class GravityBox : GravitySource
{
    ...
    [SerializeField, Min(0.0f)] float innerDistance = 3.0f;
    [SerializeField, Min(0.0f)] float innerFalloffDistance = 6.0f;
    [SerializeField, Min(0.0f)] float outerDistance = 4.0f;
    [SerializeField, Min(0.0f)] float outerFalloffDistance = 6.0f;

    float innerFalloffFactor = 0.0f;    
    float outerFalloffFactor = 0.0f;
